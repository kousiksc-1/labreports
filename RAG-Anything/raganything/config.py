...
try:
    # Optional dependency used by upstream LightRAG pipeline.
    from lightrag.utils import get_env_value  # type: ignore
except Exception:  # pragma: no cover
    # Fallback for Docker/API-only deployments (no lightrag installed).
    def get_env_value(key: str, default=None, cast_type=None):  # type: ignore
        import os
